  ...
  return (
    <div className="space-y-8 fade-in">
      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-11 pl-10 pr-4 bg-[#1a1a1a] border border-white/[0.06] rounded-xl text-sm text-white placeholder-zinc-500 outline-none focus:border-red-500/40 focus:ring-1 focus:ring-red-500/20 transition-all"
          />
          {searching && (
        ...
        sections.map((section, si) => (
          <div key={si} className="space-y-3">
            ...
            {section.items.length > 0 ? (
              ...
              <div className="text-center py-8 bg-[#0a0a0a] rounded-xl border border-white/[0.04]">
      ...
      {!searchMode && sections.length === 0 && (
        <div className="text-center py-24 bg-[#0a0a0a] rounded-2xl border border-white/[0.04]">
