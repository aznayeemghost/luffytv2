    ...
    <section className="space-y-3 scroll-section">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button onClick={() => scroll("left")} className="scroll-btn p-2 text-zinc-500 hover:text-white bg-[#1a1a1a]/80 hover:bg-purple-500/20 rounded-full transition-all backdrop-blur-sm border border-white/[0.06]">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path d="M15 19l-7-7 7-7" /></svg>
          </button>
          <button onClick={() => scroll("right")} className="scroll-btn p-2 text-zinc-500 hover:text-white bg-[#1a1a1a]/80 hover:bg-purple-500/20 rounded-full transition-all backdrop-blur-sm border border-white/[0.06]">
          ...
          <button
            ...
            className={`shrink-0 px-3 py-1.5 text-[10px] font-bold rounded-full transition-all border ${
              !activeGenre
                ...
                : "bg-[#1a1a1a] border-white/[0.04] text-zinc-500 hover:text-zinc-300"
            }`}
          >
            All
          </button>
      ...
      {loading ? (
        ...
        <>
          ...
          {trending.length === 0 && popular.length === 0 && recent.length === 0 && topRated.length === 0 && (
            <div className="text-center py-20 bg-[#0a0a0a] rounded-2xl border border-white/[0.04]">
